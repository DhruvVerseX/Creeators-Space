...
function navbar() {
  return (
    <div className="min-h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url(/bg.jpg)' }}>
      {/* Header */}
      <header className="absolute m-8  mx-88 w-[50%] p-2 z-20 backdrop-blur-sm rounded-full  bg-white/10 border border-white/20">
        <nav className="flex items-center justify-between px-8 py-4 max-w-7xl mx-auto">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="#" className="text-white/80 hover:text-white transition">How It Works</a>
            <a href="#" className="text-white/80 hover:text-white transition">Destinations</a>
      ...
      <main className="relative z-10 pt-16">
        <div className="grid grid-cols-12 gap-8 px-8 py-20 max-w-7xl mx-auto">
          ...
          <div className="col-span-12 lg:col-span-5 flex flex-col justify-center">
            ...
            <div className="inline-flex items-center gap-2 w-fit mb-8 px-4 py-2 rounded-full backdrop-blur-md bg-white/10 border border-white/20">
              ...
              <span className="text-white text-sm">Cutting-edge AI trip designs</span>
            </div>
          ...
          <div className="col-span-12 lg:col-span-7 relative flex items-center justify-end">
            <div className="w-full md:w-64 backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-white/60 text-xs mb-2">5 Days • Bali, Indonesia • Nature</p>
                <h3 className="text-white font-bold text-lg mb-3">Bali Slow Travel</h3>
                <p className="text-white/70 text-sm mb-4">A mindful itinerary blending rice...</p>
        ...
        <div className="grid grid-cols-12 gap-6 px-8 pb-20 max-w-7xl mx-auto">
          ...
          <div className="col-span-12 md:col-span-3 backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl p-6 flex flex-col justify-center">
            ...
            <p className="text-white text-sm font-semibold mb-2">With Worldwide Access, We Bring Our Top-Rated Travel Planning Solutions to Explorers Across the Globe.</p>
          </div>
        </div>
      </main>
    </div>
